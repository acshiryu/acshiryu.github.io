...
(function () {
    ...
    if (!conf.do_not_track && wlh) {
        d.write('<script type="text/javascript" src="/js/plugin.client.js" charset="utf-8"></script>')
    }
})();
